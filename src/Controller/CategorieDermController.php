 ...
 */
    public function list ()
    {
        ...
        $dermatologuescat = $this->getDoctrine()->getRepository(CategorieDerm::class)->findAll();


        return $this->render('categorie_derm/affichecatderm.html.twig', [
            'dermatologuecat' => $dermatologuescat,
        ]);
    }
